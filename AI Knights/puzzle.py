...
knowledge0 =And( Not(And(AKnight,AKnave)),
...
# B says nothing.
knowledge1 = And(Not(And(AKnight,AKnave)),
...
knowledge2 = And(Not(And(AKnight,AKnave)),
Not(And(BKnight,BKnave)),
Or(And(AKnight,BKnight), And(AKnave,BKnight)),
Or(And(BKnave,AKnave), And(BKnight,AKnave))
...
knowledge3 = And(
    Or(And(BKnight,AKnave,AKnight), BKnave),
